...
//            NSData* data = [NSData dataWithBytes:[channel.sampler.outputAccessor.bufferView.buffer contents] + channel.sampler.outputAccessor.bufferView.offset  length:channel.sampler.outputAccessor.bufferView.length];
            NSData* data = [NSData dataWithBytes:[channel.sampler.outputAccessor.bufferView.buffer contents]  length:channel.sampler.outputAccessor.bufferView.buffer.length];
